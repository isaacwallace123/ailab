...
variable "node_name" {
  description = "Proxmox node hosting the stable AI service VM."
  type        = string
  default     = "cyberlab"

  validation {
    condition     = var.node_name == "cyberlab"
    error_message = "ai-core-01 must initially target the cyberlab Proxmox node."
  }
}
...
variable "vm_id" {
  description = "Reserved VM ID for ai-core-01."
  type        = number
  default     = 9602

  validation {
    condition     = var.vm_id == 9602
    error_message = "The reviewed VM ID for ai-core-01 is 9602."
  }
}
...
variable "template_vm_id" {
  ...
  validation {
    ...
    error_message = "ai-core-01 must use the reviewed generic template 9000."
  }
}
...
variable "mac_address" {
  description = "Stable MAC address for ai-core-01."
  type        = string
  default     = "BC:24:11:09:A0:47"
...
variable "ipv4_address" {
  description = "Static AI core address outside the router DHCP pool."
  type        = string
  default     = "192.168.0.221/24"

  validation {
    condition     = var.ipv4_address == "192.168.0.221/24"
    error_message = "The reviewed static address for ai-core-01 is 192.168.0.221/24."
  }
}

variable "ipv4_gateway" {
  description = "Default gateway for the AI core LAN."
  type        = string
  default     = "192.168.0.1"

  validation {
    condition     = var.ipv4_gateway == "192.168.0.1"
    error_message = "The reviewed AI core gateway is 192.168.0.1."
  }
}
